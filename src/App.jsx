        ...
        <div className="mx-auto grid max-w-7xl gap-16 px-6 md:grid-cols-2 md:items-center">
          <div className="text-center">
            <img
              ...
              alt="Principal"
              className="mx-auto h-[380px] w-[300px] rounded-3xl object-cover shadow-2xl transition duration-500 hover:scale-105 hover:shadow-[0_0_40px_rgba(201,162,39,0.6)]"
            />
